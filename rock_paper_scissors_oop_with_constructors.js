...
Computer.prototype.choose = function () {
  ...
  let randomInndex = Math.floor(Math.random() * choices.length);
  this.move = choices[randomInndex];
};
...
RPSGame.prototype.displayWinner = function () {
  console.log(`You chose: ${this.human.move}`, `The computer chose: ${this.computer.move}`);
...
RPSGame.prototype.playAgian = function () {
